...
#define RANDSACK_RING2_BASE 0x30003200
#define RANDSACK_RING3_BASE 0x30003300
#define RANDSACK_RING4_BASE 0x30003400
#define RANDSACK_RING5_BASE 0x30003500
#define RANDSACK_RING6_BASE 0x30003600
#define RANDSACK_RING7_BASE 0x30003700
#define RANDSACK_RING8_BASE 0x30003800
#define RANDSACK_RING9_BASE 0x30003900
...
void main() {
  ...
  // Reset ring2-9.
  REG(RANDSACK_RING2_BASE + RANDSACK_RING_TRIMA_ADDR) = 50;
  REG(RANDSACK_RING2_BASE + RANDSACK_RING_TRIMB_ADDR) = 60;
  REG(RANDSACK_RING2_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_RESET_MASK;
  REG(RANDSACK_RING2_BASE + RANDSACK_RING_CONTROL_ADDR) = 0;
  ...
  // Start ring2-9.
  REG(RANDSACK_RING3_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING4_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING5_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING6_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING7_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING8_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING9_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK;
  REG(RANDSACK_RING2_BASE + RANDSACK_RING_CONTROL_ADDR) = RANDSACK_RING_CONTROL_START_MASK + (4 << RANDSACK_RING_CONTROL_CLKMUX_OFFSET);
  ...
  // Check that ring2-9 are valid.
  if (REG(RANDSACK_RING2_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING3_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING4_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING5_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING6_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING7_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING8_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
  if (REG(RANDSACK_RING9_BASE + RANDSACK_RING_COUNT_ADDR) < 10) {
    REG(RANDSACK_GPIO0_BASE + RANDSACK_GPIO_DATA) = 0x0000dead;
    return;
  }
